---
title: "/home/jim/code/code_publish/QUARTO/600_first_scss.qmd"
author: "JR"
date: today 
pdf-engine: lualatex
format:
...
execute: 
  ...
  standalone: true
---
TAGS: SCSS, class.source=, class.output=
***
...
```{scss, echo=F}
/* SCSS comment */
/* Create SCSS inside quarto (in additional to external file) */

  .X {
  background: yellow;
  }
```
This is some [yellow]{.X} using SCSS defined inside quarto file.
...
::: postbox
The background of this text should be light grey (using custom.scss) 
:::
